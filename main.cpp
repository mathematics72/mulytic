...
void NootNoot()
{
    txSetColor(RGB (65, 186, 35));               //'земля'
...
void drawSun(int x)
{
    ...
    txCircle(x, 75, 60);      //'солнце'
}

void HomeSweetHome(int x, int y)
{
    txSetColor (TX_BROWN );              //'дом'
...
txLine(141, 382, 114, 360);
txLine(114, 397, 114, 360);
}
int main()
{
